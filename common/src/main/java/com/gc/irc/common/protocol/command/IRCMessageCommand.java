...
public class IRCMessageCommand extends IRCMessage {
     ...
     *            the command type
     */
    public IRCMessageCommand(final int userId, final IRCMessageCommandType commandType) {
        this(userId);
    ...
    public String toString() {
        ...
        builder.append("IRCMessageCommand [commandType=").append(commandType).append("]");
