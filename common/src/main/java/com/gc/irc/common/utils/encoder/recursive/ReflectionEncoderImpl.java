...
public final class ReflectionEncoderImpl implements ReflectionEncoder {
    ...
    private static final transient Logger LOGGER = LoggerUtils.getLogger(ReflectionEncoderImpl.class);
    ...
    /** The object encoders. */
    private List<ObjectEncoder> objectEncoders = new FastList<ObjectEncoder>();
     ...
     *            the encoder
     */
    public ReflectionEncoderImpl(final StringEncoder encoder) {
        super();
        stringEncoder = encoder;
        if (encoder instanceof ObjectEncoder) {
            encodeAllString = true;
            objectEncoders.add((ObjectEncoder) encoder);
        }
    }
     ...
     *            the object encoders
     */
    public ReflectionEncoderImpl(final StringEncoder stringEncoder, final List<ObjectEncoder> objectEncoders) {
        this(stringEncoder);
     ...
     */
    @SuppressWarnings("unchecked")
    public ReflectionEncoderImpl(final StringEncoder stringEncoder, final List<ObjectEncoder> objectEncoders, final Collection<Class> blackList) {
     ...
     */
    private ObjectEncoder getEncoder(final Class<?> clazz) {
        ObjectEncoder result = null;
        searchEncoder: for (final ObjectEncoder objectEncoder : objectEncoders) {
    ...
    private void internalEncodeByReflection(final Object value) {
        ...
        if (value != null) {
            ...
            if (value instanceof Collection<?>) {
                ...
                final ObjectEncoder objectEncoder = getEncoder(clazz);
